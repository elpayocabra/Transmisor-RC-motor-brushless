...
//Abrimos un canal de escritura
 radio.openWritingPipe(direccion);
  ...
  Wire.begin();  //inicializar la pantalla
  oled.begin(SSD1306_SWITCHCAPVCC, 0x3C); //inicializar la pantalla
  delay(100);
...
oled.clearDisplay(); //inicio lineas de la interfaz
oled.setTextColor(WHITE);
oled.setCursor(0,0);
oled.setTextSize(1);
oled.println("--- FLAT ROVER ---");
oled.drawLine(0, 10, 128, 10, WHITE);
oled.display();
 ...
 oled.setTextColor(WHITE); //potencia en pantalla
oled.setCursor(0,25);
oled.setTextSize(1);
oled.println("POTENCIA");
